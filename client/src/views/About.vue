<template>
  <div class="About">
    ...
    <div class="grid">
      <vs-row>
        <vs-col w="6">
          <a href="#something" style="margin-inline: auto;">
              <vs-card type="2" class="card">
                <template #title>
                  <h3>The Company</h3>
                </template>
                <template #img class="about-image-collage">
    ...
    <div class="big-card">
      ...
      It was popularised in the 1960s with the release
        ...
        industry. Lorem Ip It was popularised in the 1960s with the release
        of Letraset sheets containing Lorem Ipsum passages, and more recently
        with desktop publishing software like Aldus PageMaker including versions
        of Lorem Ipsum.
      </p>
...
.collage-text {
  ...
  bottom: 25%;
  color: #061b31;
  text-shadow: #6CACF0 -0.05em 0em, #6CACF0 0.05em 0em, #6CACF0 0em 0.05em, #6CACF0 0em -0.05em;
